      ...
      <div className="Site-Content">
        ...
        <div className="searchForm">
          <form className="zipCodeForm" onSubmit={e => this.handleSearch(e)}>
            ...
            <div>
              <label htmlFor="zipInput" className="label">I'm looking for a sitter in
              </label>
              <input className="searchSitterByZipInput" id="zipInput"
                name="zipInput" type="text" placeholder="Enter Zip Code"
