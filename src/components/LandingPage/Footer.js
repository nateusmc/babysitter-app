...
export default function Footer(){
    ...
    <div className="footer-top-section">
      <div className="project-container">
        ...
        <ul>
          <li><a className='link-to-github footer-links' href='https://github.com/nateusmc/babysitter-app' target='_blank' rel="noopener noreferrer">GitHub Client</a></li>
          <li><a className='link-to-github footer-links' href='https://github.com/nateusmc/babysitter-app-server' target='_blank' rel="noopener noreferrer">GitHub Server</a></li>
