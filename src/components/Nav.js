...
export class Nav extends Component {
  ...
  render() {
      ...
      landingPageTabs = (
        <div className="nav-button right">
          <Link to="/signup" className="nav-bttn">
            <button className="nav-bttn signup btn">
              Signup
            </button>
          </Link>
            <Link to="/login" className="nav-bttn"><button className="nav-bttn login btn">Login</button></Link>
          </div>
      );
    }
    ...
    if (this.props.currentView === 'signup') {
      landingPageTabs = (
        <div className="nav-button right">
            <Link to="/signup" className="nav-bttn"><button className="nav-bttn signup btn">Signup</button></Link>
            <Link to="/login" className="nav-bttn"><button className="nav-bttn login btn">Login</button></Link>
          </div>
      );
    }
    ...
    if (this.props.currentView === 'parent') {
      parentTabs = (
        <div className="nav-button-container">
            ...
            <Link to="/parent/notifications" className="nav-bttn"><button className="nav-bttn nav-student-classes">Notifications</button></Link>
          </div>
      );
    }
    ...
    if (this.props.currentView === 'sitter') {
      sitterTabs = (
        <div className="nav-button">
            <Link to="/sitter/dashboard" className="nav-bttn"><button className="nav-bttn sitter-dashboard">Dashboard</button></Link>
            <Link to="/sitter/dashboard" className="nav-bttn"><button className="nav-bttn sitter-notifications">Notifications</button></Link>
          </div>
      );
    }
    ...
    if (this.props.currentView === 'parent' || this.props.currentView === 'sitter') {
      logoutTab = (
        <div className="nav-bttn log-out-tabs">
            <Link to="/" className="nav-bttn"><button className="logout btn" onClick={() => this.logOut()}>Logout</button></Link>
          </div>
      );
    }
